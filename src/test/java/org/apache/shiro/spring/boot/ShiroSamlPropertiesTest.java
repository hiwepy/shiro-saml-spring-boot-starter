...
/**
 * Unit tests for {{ @link ShiroSamlProperties }}.
 *
 * @author [@Loong Wan](https://github.com/loong10k)
 * @since 1.0.0
 */
@DisplayName("ShiroSamlProperties Tests")
class ShiroSamlPropertiesTest {

    @Test
    @DisplayName("Default constructor creates non-null instance")
    void testDefaultInstance() {
        ShiroSamlProperties props = new ShiroSamlProperties();
    ...
    void testPREFIXConstant() {
        assertThat(ShiroSamlProperties.PREFIX).isEqualTo("shiro.saml");
    }
