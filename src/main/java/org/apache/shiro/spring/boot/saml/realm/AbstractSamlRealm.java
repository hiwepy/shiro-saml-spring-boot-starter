 ...
 */
public abstract class AbstractSamlRealm extends AuthorizingRealm {
    
    private static Logger log = LoggerFactory.getLogger(AbstractSamlRealm.class);
